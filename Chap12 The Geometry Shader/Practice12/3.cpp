...
{
    mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders/3.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["opaqueGS"] = d3dUtil::CompileShader(L"Shaders/3.hlsl", nullptr, "GS", "gs_5_1");
    mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders/3.hlsl", nullptr, "PS", "ps_5_1");
    mInputLayout =
    {
