...
void BlendDemoApp::BuildShadersAndInputLayout()
{
	...
	mShaders["normalVS"] = d3dUtil::CompileShader(L"Shaders/5.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["normalGS"] = d3dUtil::CompileShader(L"Shaders/5.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["normalPS"] = d3dUtil::CompileShader(L"Shaders/5.hlsl", nullptr, "PS", "ps_5_0");
