...
private:
	...
	std::vector<D3D12_INPUT_ELEMENT_DESC> mStdInputLayout, mTreeSpriteInputLayout;
...
void TreeBillboardsApp::LoadTextures()
{
	...
	ThrowIfFailed(CreateDDSTextureFromFile12(md3dDevice.Get(), mCommandList.Get(),
		treeArrayTex->Filename.c_str(), treeArrayTex->Resource, treeArrayTex->UploadHeap));
...
void TreeBillboardsApp::BuildShadersAndInputLayout()
{
	...
	mShaders["treeSpriteVS"] = d3dUtil::CompileShader(L"Shaders\\6.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["treeSpriteGS"] = d3dUtil::CompileShader(L"Shaders\\6.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["treeSpritePS"] = d3dUtil::CompileShader(L"Shaders\\6.hlsl", alphaTestDefines, "PS", "ps_5_0");
