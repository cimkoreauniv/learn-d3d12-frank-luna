	...
	int3 groupThreadID : SV_GroupThreadID)
{
	...
	for (int i = -gBlurRadius; i <= gBlurRadius; i++)
		...
		* (1 - length(gCache[gBlurRadius + groupThreadID.x] - gCache[i + gBlurRadius + groupThreadID.x]));
	...
	int3 groupThreadID : SV_GroupThreadID)
{
	...
	for (int i = -gBlurRadius; i <= gBlurRadius; i++)
		...
		* (1 - length(gCache[gBlurRadius + groupThreadID.y] - gCache[i + gBlurRadius + groupThreadID.y]));;
