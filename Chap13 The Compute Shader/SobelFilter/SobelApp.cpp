...
private:
	...
	ComPtr<ID3D12Resource> mOffscreenTexture = nullptr;
...
void SobelApp::OnResize()
{
	...
	BuildOffscreenTexture();
	// The window resized, so update the aspect ratio and recompute the projection matrix.
	XMMATRIX P = XMMatrixPerspectiveFovLH(0.25f * MathHelper::Pi, AspectRatio(), 1.0f, 1000.0f);
	XMStoreFloat4x4(&mProj, P);
}

void SobelApp::BuildOffscreenTexture()
{
...
void SobelApp::BuildOffscreenDescriptors()
{
	md3dDevice->CreateRenderTargetView(mOffscreenTexture.Get(), nullptr,
		CD3DX12_CPU_DESCRIPTOR_HANDLE(mRtvHeap->GetCPUDescriptorHandleForHeapStart(), SwapChainBufferCount, mRtvDescriptorSize));
}
