...
void BlendDemoApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Default_9.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Default_9.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"Shaders\\Default_9.hlsl", alphaTestDefines, "PS", "ps_5_0");
...
void BlendDemoApp::BuildPSOs()
{
	...
	addBlendDesc.SrcBlendAlpha = D3D12_BLEND_ZERO;
	...
	opaquePsoDesc.BlendState.RenderTarget[0] = addBlendDesc;
	...
	//transparentPsoDesc.BlendState.RenderTarget[0] = addBlendDesc;
