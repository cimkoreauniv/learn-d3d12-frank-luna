...
void BoxApp::BuildShadersAndInputLayout()
{
    ...
    mvsByteCode = d3dUtil::CompileShader(L"Shaders/color_15.hlsl", nullptr, "VS", "vs_5_0");
    mpsByteCode = d3dUtil::CompileShader(L"Shaders/color_15.hlsl", nullptr, "PS", "ps_5_0");
    mInputLayout =
    {
