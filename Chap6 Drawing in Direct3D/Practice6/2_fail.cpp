...
void BoxApp::BuildBoxGeometry()
{
    ...
    VPosGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCommandList.Get(), vpos.data(), 8 * sizeof(VPosData), u);
    VColorGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCommandList.Get(), vcolor.data(), 8 * sizeof(VColorData), u);
    IndexGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCommandList.Get(), indices.data(), indices.size() * sizeof(std::uint16_t), u);
