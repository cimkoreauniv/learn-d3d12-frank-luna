...
{
    mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders/Default_6.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders/Default_6.hlsl", nullptr, "PS", "ps_5_1");
    mInputLayout =
    {
