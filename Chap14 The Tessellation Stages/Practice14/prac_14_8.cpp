...
private:
	...
	std::vector<std::unique_ptr<FrameResource2>> mFrameResources;
	FrameResource2* mCurrFrameResource = nullptr;
...
{
	std::wstring shader = L"Shaders\\Shader_14_8.hlsl";
	mShaders["tessVS"] = d3dUtil::CompileShader(shader, nullptr, "VS", "vs_5_0");
	mShaders["tessHS"] = d3dUtil::CompileShader(shader, nullptr, "HS", "hs_5_0");
	mShaders["tessDS"] = d3dUtil::CompileShader(shader, nullptr, "DS", "ds_5_0");
	mShaders["tessPS"] = d3dUtil::CompileShader(shader, nullptr, "PS", "ps_5_0");
...
void BezierPatchApp::BuildFrameResources()
{
	...
	{
		mFrameResources.push_back(std::make_unique<FrameResource2>(md3dDevice.Get(),
